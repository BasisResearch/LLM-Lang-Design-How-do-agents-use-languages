...
// Required imports for correct functionality
...
// Enable postfix operators to avoid errors
...
// Define the JSON format (inside its own object to be used correctly)
...
// Main application
object WorkingTodoApp extends App {
