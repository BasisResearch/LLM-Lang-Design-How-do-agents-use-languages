...
LANGUAGES = [
    "assembly", "c", "python", "javascript", "python-mypy",
    "typescript", "java", "scala", "rust", "haskell",
]
...
MODELS = {
    ...
    "gpt-5": "openai",
    # OpenRouter - Qwen
    "openrouter/qwen/qwen3-coder-plus": "openrouter-other",
    "openrouter/qwen/qwen3.7-plus": "openrouter-other",
}
...
def run_one(model, language, rep, total):
    ...
    try:
        ...
        cmd = [
            sys.executable, f"{BASE_DIR}/agent.py",
            "--model", model,
            "--language", language,
            "--workdir", workdir,
            "--output", result_path,
...
def schedule_all(models=None, languages=None, reps=None, max_workers=8):
    ...
    LANG_SPEED = {
        ...
        "java": 1, "rust": 2, "scala": 2, "c": 2,
        "haskell": 3, "assembly": 3,
    }
    import random
    random.seed(42)
